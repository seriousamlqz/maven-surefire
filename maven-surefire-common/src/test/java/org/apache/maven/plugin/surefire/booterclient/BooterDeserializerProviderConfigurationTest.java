    ...
    extends TestCase
{
    ...
    private final Boolean rerunFailingTests = true;
        ...
        throws IOException
    {
        ...
        Assert.assertEquals( rerunFailingTests, testSuiteDefinition.getRerunFailingTests() );
                                                                ...
                                                                boolean readTestsFromInStream )
    {
        ...
        TestRequest testSuiteDefinition =
            new TestRequest( getSuiteXmlFileStrings(), getTestSourceDirectory(), aUserRequestedTest,
                             aUserRequestedTestMethod, rerunFailingTests, rerunFailingTestsCount );
